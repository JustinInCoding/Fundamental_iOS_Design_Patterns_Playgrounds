...
// MARK: - Product
public struct Hambuger {
	public let meat: Meat
	public let sauce: Sauces
	public let toppings: Toppings
}

extension Hambuger: CustomStringConvertible {
...
public class HamburgerBuilder {
	...
	public func build() -> Hambuger {
		return Hambuger(meat: meat, sauce: sauces, toppings: toppings)
	}
}

// MARK: - Director
public class Employee {
	public func createCombo1() throws -> Hambuger {
	...
	public func createKittenSpecial() throws -> Hambuger {
		let builder = HamburgerBuilder()
